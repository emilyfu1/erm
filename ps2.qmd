...
print(paste0('p(average household switches) = ', p_switch_meandist))
```
...
# logit coefficient
bhat_dist100_fit1 = coef(fit1)['dist100']

# marginal effect of average person
avg_marginal_effect = bhat_dist100_fit1 * p_switch_meandist
...
marginal_effect_all = bhat_dist100_fit1 * prob_switch_all
...
```{r}
confusion = table(pred1 = wells$pred1, switch = wells$switch)
print(confusion)
```
### e)
...
n_true_positives = confusion['1', '1']
n_true_negatives = confusion['0', '0']
n_false_positives = confusion['1', '0']
n_false_negatives = confusion['0', '1']
